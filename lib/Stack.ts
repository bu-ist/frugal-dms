...
/**
 * The main CDK stack that sets up the DMS replication environment, including VPC, endpoints, 
 * and optional target database.
 */
export class FrugalDmsStack extends Stack {
  ...
  public static getInstance = async (props: ExtendedStackProps): Promise<FrugalDmsStack> => {

    const dmsStack = new FrugalDmsStack(props);
