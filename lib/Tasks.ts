 ...
 * (replication resources are dynamically created during the normal operation of this app using the SDK).
 *
 * This class is for pre-defining a set of replication tasks to be cloudformed with the CDK, either as serverless 
 * configurations, or as standard tasks with replication instances to run them on.
 */
export class Tasks {
